...
/// > --- Macro IMPLEMENT_DYNCREATE( Derived, Base ) Begin ---
CObject* PASCAL Derived::CreateObject( ) { return new Derived; }

const CRuntimeClass Derived::classDerived = //
    { "Derived",
      sizeof( class Derived ),
      0xFFFF,
      Derived::CreateObject, // pfnNew
      const_cast<CRuntimeClass*>( &Base::classBase ),
      NULL,
      NULL };

CRuntimeClass* Derived::GetRuntimeClass( ) const { return const_cast<CRuntimeClass*>( &Derived::classDerived ); }
/// > --- Macro IMPLEMENT_DYNCREATE( Derived, Base ) End ---

int main( )
{
    // CObject* pob = const_cast<CRuntimeClass*>(&Derived::classDerived)->CreateObject();
    // Call CRuntimeClass::CreateObject() -> function pointer -> Derived::CreateObject();
