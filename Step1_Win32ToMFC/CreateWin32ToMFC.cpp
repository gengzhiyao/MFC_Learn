 ...
 * 3.
 * 利用theApp调用InitInstance，我们重写了该函数，就可以在函数中创建我们的窗口并显示
...
// 以上ON_MESSAGE代码通过宏展开后是数组的_messageEntries成员，ON_MESSAGE形式为：ON_MESSAGE(message,
// memberFxn)
// 展开后为：{ message, 0, 0, 0,
// AfxSig_lwl,(AFX_PMSG)(AFX_PMSGW)(static_cast< LRESULT (AFX_MSG_CALL
// CWnd::*)(WPARAM, LPARAM) > (memberFxn)) }
// 其中message形参为消息ID，比如WM_CREATE
...
/**
 * 消息的分类：
 * 1. 标准windows消息    ->   使用宏：ON_WM_****  如：ON_WM_CREATE
 * ON_WM_SETCURSOR
